...
int main()
{
  ...
  cout << "Testing of the Implemented Queue.h using Queue" << endl;
  cout << endl;    
  ...
  for(Queue<double> cpy = x; !cpy.isEmpty(); cpy.pop(item))
  {
    //const object copy testing, with assignment upon declaration
    const Queue<double> cpy2 = cpy;
    if (cpy2.isEmpty())
      break;
